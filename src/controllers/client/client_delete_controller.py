...
class ClientDeleteController(Controller[dict[str, Any], None | Exception]):
    """."""

    def __init__(
        self,
        db_get_one_operation: DbGetOneOperation[ClienteModel],
        db_delete_operation: DbDeleteOperation[ClienteModel],
    ) -> None:
        """."""
