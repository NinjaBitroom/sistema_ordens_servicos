...
class EducationDeleteController(Controller[dict[str, Any], None | Exception]):
    """."""

    def __init__(
        self,
        db_get_one_operation: DbGetOneOperation[EscolaridadeModel],
        db_delete_operation: DbDeleteOperation[EscolaridadeModel],
    ) -> None:
        """."""
