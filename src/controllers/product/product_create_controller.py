...
class ProductCreateController(
    ...
    def __init__(
        ...
        db_add_one_operation: DbAddOneOperation[ProdutoModel],
        form_to_model_operation: FormToModelOperation[FlaskForm, ProdutoModel],
        sql_model_validation: Validation[ProdutoModel],
    ) -> None:
        """."""
