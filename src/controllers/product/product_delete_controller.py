...
class ProductDeleteController(Controller[dict[str, Any], None | Exception]):
    """."""

    def __init__(
        self,
        db_get_one_operation: DbGetOneOperation[ProdutoModel],
        db_delete_operation: DbDeleteOperation[ProdutoModel],
    ) -> None:
        """."""
