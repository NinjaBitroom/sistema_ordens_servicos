...
class EmployeePositionCreateController(
    ...
    def __init__(
        ...
        db_add_one_operation: DbAddOneOperation[CargoDoFuncionarioModel],
        form_to_model_operation: FormToModelOperation[
            FlaskForm, CargoDoFuncionarioModel
        ],
        sql_model_validation: Validation[CargoDoFuncionarioModel],
    ) -> None:
        """."""
