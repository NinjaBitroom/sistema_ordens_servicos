...
class EmployeePositionDetailController(
    Controller[dict[str, Any], CargoDoFuncionarioModel | Exception]
):
    """."""

    def __init__(
        self, db_get_one_operation: DbGetOneOperation[CargoDoFuncionarioModel]
    ) -> None:
        """."""
    ...
    ) -> HttpResponse[CargoDoFuncionarioModel | Exception]:
        """."""
