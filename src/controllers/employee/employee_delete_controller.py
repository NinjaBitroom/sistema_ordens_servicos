...
class EmployeeDeleteController(Controller[dict[str, Any], None | Exception]):
    """."""

    def __init__(
        self,
        db_get_one_operation: DbGetOneOperation[FuncionarioModel],
        db_delete_operation: DbDeleteOperation[FuncionarioModel],
    ) -> None:
        """."""
