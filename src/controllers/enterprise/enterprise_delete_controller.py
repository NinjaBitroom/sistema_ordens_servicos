...
class EnterpriseDeleteController(Controller[dict[str, Any], None | Exception]):
    """."""

    def __init__(
        self,
        db_get_one_operation: DbGetOneOperation[EmpresaModel],
        db_delete_operation: DbDeleteOperation[EmpresaModel],
    ) -> None:
        """."""
