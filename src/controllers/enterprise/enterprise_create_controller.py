...
class EnterpriseCreateController(
    ...
    def __init__(
        ...
        db_add_one_operation: DbAddOneOperation[EmpresaModel],
        form_to_model_operation: FormToModelOperation[FlaskForm, EmpresaModel],
        sql_model_validation: Validation[EmpresaModel],
    ) -> None:
        """."""
