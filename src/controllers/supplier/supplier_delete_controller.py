...
class SupplierDeleteController(Controller[dict[str, Any], None | Exception]):
    """."""

    def __init__(
        self,
        db_get_one_operation: DbGetOneOperation[FornecedorModel],
        db_delete_operation: DbDeleteOperation[FornecedorModel],
    ) -> None:
        """."""
