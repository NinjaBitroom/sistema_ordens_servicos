...
class BrandCreateController(
    ...
    def __init__(
        ...
        db_add_one_operation: DbAddOneOperation[MarcaModel],
        form_to_model_operation: FormToModelOperation[FlaskForm, MarcaModel],
        sql_model_validation: Validation[MarcaModel],
    ) -> None:
        """."""
